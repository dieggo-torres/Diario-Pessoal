...
app.get('/sobre', (req, res) => {
  res.render('sobre', { conteudo: sobreConteudoInicial })
})

app.get('/contato', (req, res) => {
  res.render('contato', { conteudo: contatoConteudoInicial })
})
